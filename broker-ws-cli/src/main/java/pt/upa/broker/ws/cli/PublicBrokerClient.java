 ...
 */
public class PublicBrokerClient implements BrokerPortType {
	/** WS service */
	...
	public PublicBrokerClient(String wsURL) throws BrokerClientException {
		this.wsURL = wsURL;
		createStub();
	}

	/** constructor with provided UDDI location and name */
	public PublicBrokerClient(String uddiURL, String wsName) throws BrokerClientException {
