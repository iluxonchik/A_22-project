 ...
 */
public class PublicTransporterClient implements TransporterPortType {
	...
	public PublicTransporterClient(String wsURL) throws TransporterClientException {
		this.wsURL = wsURL;
		createStub();
	}

	/** constructor with provided UDDI location and name */
	public PublicTransporterClient(String uddiURL, String wsName) throws TransporterClientException {
